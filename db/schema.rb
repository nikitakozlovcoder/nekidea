...
ActiveRecord::Schema.define(version: 2160_05_11_164738) do
  ...
  create_table "ideas_downusers", id: false, force: :cascade do |t|
    t.bigint "idea_id"
    t.bigint "user_id"
    t.index ["idea_id"], name: "index_ideas_downusers_on_idea_id"
    t.index ["user_id"], name: "index_ideas_downusers_on_user_id"
  end

  create_table "ideas_upusers", id: false, force: :cascade do |t|
    t.bigint "idea_id"
    t.bigint "user_id"
    t.index ["idea_id"], name: "index_ideas_upusers_on_idea_id"
    t.index ["user_id"], name: "index_ideas_upusers_on_user_id"
  end
